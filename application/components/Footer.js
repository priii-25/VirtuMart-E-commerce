...
<section className="text-gray-400 bg-gray-900 body-font relative">
  ...
  marginWidth="0"
  scrolling="no"
  src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=%C4%B0zmir+(My%2Business%20Name)&ie=UTF8&t=&z=14&iwloc=B&output=embed"
  style={iframeStyle}
/>
      <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
        ...
        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
          ...
          <a className="text-yellow-400 leading-relaxed">example@email.com</a>
